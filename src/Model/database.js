  ...
  users: [
    {
      ...
      wallet: {
        ...
        transactions: [
          { id: "1", type: "credit", amount: 140, date: "2025-08-14", from: "Ahmed", to: "124847", etat: "success" },
          { id: "2", type: "debit", amount: 200, date: "2025-08-13", from: "124847", to: "Amazon", etat: "success" },
          { id: "3", type: "credit", amount: 250, date: "2025-08-12", from: "Ahmed", to: "124478", etat: "success" }
        ],
        beneficiaries: [
    ...
    },
    {
      ...
      wallet: {
        ...
        transactions: [
          { id: "1", type: "credit", amount: 140, date: "2025-08-14", from: "Ali", to: "12347", etat: "success" },
          { id: "2", type: "debit", amount: 200, date: "2025-08-13", from: "12347", to: "Amazon", etat: "success" },
          { id: "3", type: "credit", amount: 250, date: "2025-08-12", from: "Ali", to: "224478", etat: "success" }
        ],
        beneficiaries: [
